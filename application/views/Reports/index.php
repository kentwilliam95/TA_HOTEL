...
<ul class="nav nav-pills">
	...
	<li><a data-toggle="pill" href="#reportKamar"><strong>Room</strong></a></li>
</ul>
</div>
<hr>
<br>
...
<div class="tab-content">
    ...
    <div id="payroll" class="tab-pane fade">
      <table id="tabelPayroll" class="table table-striped table-bordered "> 
	  
	  </table>
    </div>
    <div id="Income" class="tab-pane fade">
     <table id="tabelIncome" class="table table-striped table-bordered "> 
	  
	  </table>
    </div>
    <div id="menu3" class="tab-pane fade">
     <table id="tabelInventaris" class="table table-striped table-bordered "> 
	  
	  </table>
    </div>
	
	<div id="ReservasiReport" class="tab-pane fade">
		<table id="tabelReservasi" class="table table-striped table-bordered ">
		
		</table>
	</div>
	
	<div id="reportMenuRestaurant" class="tab-pane fade"> 
		<table id="tabelMenuRestaurant" class="table table-striped table-bordered ">
		
		</table>
	</div>
	
	<div id="reportUseRestaurant" class="tab-pane fade"> 
		<table id="tabelUseRestaurant" class="table table-striped table-bordered ">
		
		</table>
	</div>
	
	<div id="reportKamar" class="tab-pane fade"> 
		<table id="tabelKamar" class="table table-striped table-bordered">
