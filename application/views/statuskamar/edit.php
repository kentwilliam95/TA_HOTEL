  ...
  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" />
    <?php echo validation_errors(); echo $message;?>
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <input type="text" name="kode" class="form-control" value="<?php echo $statuskamar['id_kamar'];?>" readonly="readonly">
                    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-5">
            <input type="text" name="tglawal" id="tanggal" class="form-control" value="<?php echo $statuskamar['tgl_statusawal'];?>">
        </div>
    </div>
	<div class="form-group">
        <label class="col-lg-2 control-label">Tanggal Akhir</label>
        <div class="col-lg-5">
            <input type="text" name="tglakhir" id="tanggal2" class="form-control" value="<?php echo $statuskamar['tgl_statusakhir'];?>">
        </div>
    </div>
	<div class="form-group">
       ...
       <select name="statuskamar" class="form-control" id="statuskamar">
	                   <option value="<?php echo $statuskamar['status'];?>"><?php echo $statuskamar['status'];?></option>
