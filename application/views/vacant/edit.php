<script>
    $(function(){
        ...
        $("#simpan").click(function(){
            ...
            if (no=="" || nis=="") {
                ...
                if (nominal=="") {
                    ...
                    $.ajax({
                        url:"<?php echo site_url('vacant/simpan');?>",
                        type:"POST",
        ...
        $("#carinis").keyup(function(){
            ...
            $.ajax({
                url:"<?php echo site_url('vacant/cari_by_nis');?>",
                type:"POST",
                data:"nis="+nis,
                cache:false,
                success:function(html){
  ...
  <form class="form-horizontal" action="" method="post" enctype="multipart/form-data" />
    <?php echo validation_errors(); echo $message;?>
                <div class="form-group">
                    ...
                    <div class="col-lg-5">
                        <input type="text" name="kode" class="form-control" value="<?php echo $vacant['id_kamar'];?>" readonly="readonly">
                    </div>
	...
	<div class="form-group">
        ...
        <div class="col-lg-5">
            <input type="text" name="tglawal" id="tanggal" class="form-control" value="<?php echo $vacant['tgl_statusawal'];?>">
        </div>
    </div>
	<div class="form-group">
        <label class="col-lg-2 control-label">Tanggal Akhir</label>
        <div class="col-lg-5">
            <input type="text" name="tglakhir" id="tanggal2" class="form-control" value="<?php echo $vacant['tgl_statusakhir'];?>">
        </div>
    </div>
	<div class="form-group">
       ...
       <select name="statuskamar" class="form-control" id="statuskamar">
	                   <option value="<?php echo $vacant['status'];?>"><?php echo $vacant['status'];?></option>
    ...
    <div class="form-group well">
        ...
        <a href="<?php echo site_url('statuskamar');?>" class="btn btn-default">Kembali</a>
    </div>
</form>
