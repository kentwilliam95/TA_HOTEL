...
<a href="<?php echo site_url('occupied/standardoccupied');?>" class="btn btn-primary"> Standard Room</a>
<a href="<?php echo site_url('occupied/superioroccupied');?>" class="btn btn-primary"> Superior Room</a>
<a href="<?php echo site_url('occupied/deluxeoccupied');?>" class="btn btn-primary"> Deluxe Room</a>
<hr>
<?php echo $message;?>
