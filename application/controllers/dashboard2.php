...
class Dashboard2 extends CI_Controller{
    ...
    function index(){
        ...
        $this->template2->display('dashboard2/index',$data);
    }
    ...
    function petugas(){
        ...
        if($this->uri->segment(3)=="delete_success")
            ...
            $data['message']='';
        $this->template2->display('dashboard2/petugas',$data);
    }
    ...
    function tambahpetugas(){
        ...
        if($this->form_validation->run()==true){
            ...
            if($cek->num_rows()>0){
                ...
                $this->template2->display('dashboard2/tambahpetugas',$data);
            }else{
                $info=array(
                    'user'=>$this->input->post('user'),
                ...
                redirect('dashboard2/petugas/add_success');
            }
        }else{
            $data['message']="";
            $this->template2->display('dashboard2/tambahpetugas',$data);
    ...
    function edit($id){
        ...
        if($this->form_validation->run()==true){
            ...
            $this->template2->display('dashboard2/editpetugas',$data);
        }else{
            $data['message']="";
            $data['petugas']=$this->m_petugas->cekId($id)->row_array();
            $this->template2->display('dashboard2/editpetugas',$data);
